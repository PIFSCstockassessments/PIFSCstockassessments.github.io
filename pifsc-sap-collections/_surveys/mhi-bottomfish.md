...
permalink: /surveys/mhi-bottomfish/
description: |
...
2. Underwater stereo-cameras called MOUSS (Modular Optical Underwater
Survey System).

Sampling locations are chosen at random each year based on habitat type. During
the survey period, which typically runs from August through October, fishing for
bottomfish occurs for 30 minutes at each location using two lines, each baited with
four standard-size hooks. PIFSC researchers also deploy cameras from a NOAA
research vessel. For both gear types, all fish caught or seen are recorded, counted,
and measured.
