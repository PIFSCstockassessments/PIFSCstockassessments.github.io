...
Recently, an approach was developed to estimate the recreational component of the Deep 7 fishery that relies on using the Bottomfish Vessel Registry. An \[interactive web application\] (i.e., Shiny app) was developed to aid in assessing the effects of decision points on the estimated recreational catch using the new approach.
